...
export const ImageCard: React.FC<ImageCardProps> = ({ image, isSelected, onSelect, onDelete, isDeleting }) => {
  return (
    <Card
    ...
    >
      <CardContent className="p-0 cursor-pointer">
        ...
        >
          <div
            className={`h-6 w-6 rounded-md flex items-center justify-center ${isSelected ? 'bg-pink-500 border-pink-500' : 'bg-white/50 border-gray-400 border'}`}
          >
